...
SRC=                                      \
	...
	../rtl/wb_SPI/wb_SPI.v				  \
	../rtl/wb_SPI/topSPI.v				  \
	../rtl/wb_SPI/byteMISO.v				  \
	../rtl/wb_SPI/byteMOSI.v				  \
	../rtl/wb_SPI/control_SPI.v				  \
	../rtl/wb_SPI/datapath_SPI.v				  \
	../rtl/wb_SPI/SCK.v				  \
	../rtl/wb_LCD/wb_LCD.v				  \
	../rtl/wb_LCD/top_LCD.v				  \
	../rtl/wb_LCD/fsm_LCD.v				  \
	../rtl/wb_LCD/datapath_LCD.v				  \
	../rtl/wb_Teclado/datapath_Teclado.v		  \
	../rtl/wb_Teclado/fsm_Teclado.v		  \
	../rtl/wb_Teclado/top_Teclado.v		  \
	../rtl/wb_Teclado/wb_Teclado.v		  \
	../rtl/wb_conbus/conbus.v          \
	../rtl/wb_conbus/conbus_arb.v      \
	../rtl/wb_sram/wb_sram32.v
#Se agregó ../rtl/wb_SPI/wb_SPI.v	\
#../rtl/wb_SPI/topSPI.v				  \
#	../rtl/wb_SPI/byteMISO.v				  \
#	../rtl/wb_SPI/byteMOSI.v				  \
#	../rtl/wb_SPI/control_SPI.v				  \
...
prog:
	$(DIG) prog -d Nexys4 --index 0 --file $(SYSTEM) 
#-----------------------
#############################################################################
